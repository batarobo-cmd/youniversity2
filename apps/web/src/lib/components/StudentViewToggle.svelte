<script lang="ts">
  ...
  import { locale, isAdminUser, studentViewMode } from '$lib/stores/auth';

  import { applyStudentViewToggle } from '$lib/student-view-navigation';
  ...
  function toggle() {
    ...
    applyStudentViewToggle(next, path);
...
<style>
  ...
  .student-view-toggle-btn:disabled {
